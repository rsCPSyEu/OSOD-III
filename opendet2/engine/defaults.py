...
from ..evaluation import PascalVOCDetectionEvaluator, COCOEvaluator_unk
...
class OpenDetTrainer(TrainerBase):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type == "pascal_voc":
            ...
            # return COCOEvaluator(dataset_name, ('bbox',), output_dir=output_folder) # NOTE: To check the performance of pretrained-detector model.
            return COCOEvaluator_unk(dataset_name, cfg, True, output_folder)
    ...
    def test(cls, cfg, model, evaluators=None):
        ...
        for idx, dataset_name in enumerate(cfg.DATASETS.TEST):
            ...
            if evaluator.__class__.__name__ == 'COCOEvaluator_unk':
                from ..evaluation.evaluator import inference_on_dataset # overwrite on default (i.e., detectron2) function                
                results_i = inference_on_dataset(model, data_loader, evaluator, cfg=cfg, eval_unknown=True)
            else:
