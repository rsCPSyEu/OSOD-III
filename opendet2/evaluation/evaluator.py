...
def inference_on_dataset(model, data_loader, evaluator, cfg=None, eval_unknown=False):
    """
    ...
    others_attrs = [
        {'keep': False, 'ignore': False}, # others GTs are removed annotation, i.e., bg
    ]
    
    # batch_size == 1 in evaluation
